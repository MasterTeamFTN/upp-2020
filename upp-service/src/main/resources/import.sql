...
INSERT INTO users (id, email, enabled, first_name, last_name, last_password_reset_date, password, username, dtype, city_country, is_beta_reader, penalty_points) VALUES (4, "jankobree@hotmail.com", true, "Board", "Memberovic", "2017-09-01 22:40:00", "$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra", "board.member", "BoardMember", "Belgrade, Serbia", false, 0);
INSERT INTO users (id, email, enabled, first_name, last_name, last_password_reset_date, password, username, dtype, city_country, is_beta_reader, penalty_points) VALUES (5, "jankobree@hotmail.com", true, "member", "Boardovic", "2017-09-01 22:40:00", "$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra", "member.board", "BoardMember", "Belgrade, Serbia", false, 0);
...
INSERT INTO user_authority (user_id, authority_id) VALUES (4, 6);   # board - BoardMember
INSERT INTO user_authority (user_id, authority_id) VALUES (5, 6);   # member - BoardMember
