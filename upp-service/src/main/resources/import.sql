...
INSERT INTO users (id, email, enabled, first_name, last_name, last_password_reset_date, password, username, dtype, city_country, is_beta_reader, penalty_points, is_member) VALUES (13, "jankobree+4@hotmail.com", true, "Pera", "Peric", "2017-09-01 22:40:00", "$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra", "pera.peric", "Writer", "Belgrade, Serbia", false, 0, 1);
...
INSERT INTO books (id, is_published,is_plagiarized,  num_of_pages, title, genre_id, writer_id, synopsis, year, is_rejected, city_country) VALUES (1, true, false, 250, "First book", 1, 1, "", 2020, false, "Novi Sad, Serbia");
INSERT INTO books (id, is_published,is_plagiarized,  num_of_pages, title, genre_id, writer_id, synopsis, year, is_rejected, city_country) VALUES (2, true, false, 250, "Plagiat", 1, 13, "", 2021, false, "Belgrade, Serbia");
